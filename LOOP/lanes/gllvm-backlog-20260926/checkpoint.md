...
USAGE LIMIT HIT ~17:00Z (reset 17:50Z): killed fix500, wave-3 Opus verify, rework-502, triage mid-flight. Resumed 17:51Z with <=3 live: finish-500 (picks up 157+/19- uncommitted WIP in gllvm-twopart-484), rework-502b. Queued: Opus verify (#500/#491/#493) after finish-500; mode-search triage. Stale leases of dead agents released.
TRIAGE done: #503 (tracking: NB1 grouped, StudentT x2 highest; GP1, BetaBinomial, mixed, COMPoisson medium; Tweedie/NB2 grouped to confirm; ordinal clean; covered: Gamma, Beta, covariate kernel via #494 (by reading its diff), twopart via #500) and #504 (confint bootstrap/profile-refit accept non-converged replicates; lines verified on main).
