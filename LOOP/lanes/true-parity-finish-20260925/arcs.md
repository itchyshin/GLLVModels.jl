...
| id | arc | status | notes |
|---|---|---|---|
| S1 | A-13 gate-tier scoreboard (32 rows + the 42-vs-32 count) | RUNNING | draft PR |
...
| S7b | Two-part kernel fix PR for #484 (pattern of #481) | TODO | ZI families are paired rows |
